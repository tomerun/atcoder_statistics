...
class Scraper:
  ...
  def crawl_contests_list(self, db_session):
    ...
    for page in page_list:
      ...
      contests = contests + self._crawl_contests_list_page(link.get('href'))
  ...
  def crawl_task_point(self, task, db_session):
    ...
    if match:
      ...
      task_point = TaskPoint(contest_id=task.contest_id, problem_id=task.problem_id, point=point * 100)  # normalize
